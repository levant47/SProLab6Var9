...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (message)
    {
        case WM_CREATE:
        {
            ...
            AppendMenuW(hMenu, MF_STRING, MenuOptionId::FILE_CREATE, L"Створити файл");
            AppendMenuW(hMenu, MF_STRING, MenuOptionId::FILE_DELETE, L"Видалити файли");
            AppendMenuW(hMenu, MF_STRING, MenuOptionId::FILE_READ, L"Прочитати файл");
            AppendMenuW(hMenu, MF_STRING, MenuOptionId::FILE_COPY, L"Копіювати текст");
